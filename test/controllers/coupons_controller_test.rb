...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { description: @coupon.description, name: @coupon.name, picture: @coupon.picture, used: @coupon.used }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { description: @coupon.description, name: @coupon.name, picture: @coupon.picture, used: @coupon.used }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
